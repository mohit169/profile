...
export default function Footer() {
    ...
    return (
        <footer className="py-8 bg-gray-950 text-gray-300">
            <div className={`container mx-auto px-4 transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-6 md:mb-0">
                        <h3 className="text-xl font-bold mb-2 text-white">Mohit Bhatt</h3>
                        <p className="text-sm text-gray-400">Full-Stack Developer & Designer</p>
                    </div>
                    
                    <div className="grid grid-cols-3 gap-x-8 gap-y-2 mb-6 md:mb-0">
                        <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Home</a>
                        <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Projects</a>
                    ...
                    <div className="flex space-x-4">
                        <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors transform hover:-translate-y-1 inline-block">
                ...
                <div className="mt-8 pt-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-sm text-gray-500">© {currentYear} Mohit Bhatt. All rights reserved.</p>
